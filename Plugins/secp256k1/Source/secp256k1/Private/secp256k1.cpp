...
#define LOCTEXT_NAMESPACE "Fsecp256k1Module"
#include "secp256k1Library/secp256k1.h"

void Fsecp256k1Module::StartupModule()
{
...
void Fsecp256k1Module::ShutdownModule()
{
...
IMPLEMENT_MODULE(Fsecp256k1Module, secp256k1)
