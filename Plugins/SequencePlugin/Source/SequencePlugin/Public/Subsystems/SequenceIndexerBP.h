...
public:
	...
	UFUNCTION(BlueprintCallable, Category="0xSequence SDK - Indexer")
	void GetTokenBalances(const FString& WalletAddress, const FString& ContractAddress, const FSeqPage Page, const bool IncludeMetadata, FOnGetTokenBalances OnSuccess, FOnFailure OnFailure);
	
	UFUNCTION(BlueprintCallable, Category="0xSequence SDK - Indexer")
	void GetTokenSupplies(const FString& ContractAddress, const FSeqPage Page, const bool IncludeMetadata, FOnGetTokenSupplies OnSuccess, FOnFailure OnFailure);
