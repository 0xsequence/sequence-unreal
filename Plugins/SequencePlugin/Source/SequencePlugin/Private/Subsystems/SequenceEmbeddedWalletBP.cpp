#include "Subsystems/SequenceEmbeddedWalletBP.h"
#include "Engine/Engine.h"
#include "Sequence/SequenceEmbeddedWallet.h"

USequenceEmbeddedWalletBP::USequenceEmbeddedWalletBP()
{
	this->Wallet = NewObject<USequenceEmbeddedWallet>();
}

FString USequenceEmbeddedWalletBP::GetWalletAddress()
{
	return this->Wallet->GetWalletAddress();
}

void USequenceEmbeddedWalletBP::UpdateProviderUrl(const FString& NewProviderUrl)
{
	return this->Wallet->UpdateProviderURL(NewProviderUrl);
}

void USequenceEmbeddedWalletBP::SignOut()
{
	this->Wallet->SignOut();
	this->CallOnSessionClosed();
}

void USequenceEmbeddedWalletBP::SignMessage(const FString& Message, FOnSignMessage OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::ValidateMessageSignature(const int64& ChainId, const FString& WalletAddress, const FString& Message, const FString& Signature, FOnValidateMessageSignature OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::GetFilteredFeeOptions(UTransactions * Transactions, FOnGetFilteredFeeOptions OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::GetUnfilteredFeeOptions(UTransactions * Transactions, FOnGetUnFilteredFeeOptions OnSuccess, FOnFailure OnFailure)
{
	const TFunction<void (TArray<FFeeOption>)> OnApiSuccess = [this, OnSuccess](const TArray<FFeeOption>& FeeOptions)
	{
		OnSuccess.ExecuteIfBound(FeeOptions);
...
void USequenceEmbeddedWalletBP::SendNativeToken(const FString& RecipientAddress, const FString& Amount, FOnSendTransaction OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::SendTransactionWithFee(UTransactions * Transactions, FOnSendTransaction OnSuccess, FOnFailure OnFailure)
{
	const TFunction<void (FSeqTransactionResponse_Data)> OnApiSuccess = [this, OnSuccess](const FSeqTransactionResponse_Data& Response)
	{
		OnSuccess.ExecuteIfBound(Response.Receipt.TxnReceipt, Response);
...
void USequenceEmbeddedWalletBP::SendTransaction(UTransactions * Transactions, FOnSendTransaction OnSuccess, FOnFailure OnFailure)
{
	const TFunction<void (FSeqTransactionResponse_Data)> OnApiSuccess = [this, OnSuccess](const FSeqTransactionResponse_Data& Response)
	{
		OnSuccess.ExecuteIfBound(Response.Receipt.TxnReceipt, Response);
...
void USequenceEmbeddedWalletBP::GetIdToken(const FString& Nonce, FOnGetIdToken OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::ListSessions(FOnListSessions OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::ListAccounts(FOnListAccounts OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::GetSessionAuthProof(const FString& Nonce, FOnGetSessionAuthProof OnSuccess, FOnFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::GetLinkedWallets(FOnLinkedWallets OnSuccess, FOnLinkedWalletsFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::RemoveLinkedWallet(const FString& LinkedWalletAddress, FOnSuccess OnSuccess, FOnLinkedWalletsFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::Call(const FContractCall& ContractCall, FOnCallResponse OnSuccess, FOnLinkedWalletsFailure OnFailure)
{
...
void USequenceEmbeddedWalletBP::CallOnSessionClosed() const
{
...
USequenceEmbeddedWallet* USequenceEmbeddedWalletBP::GetSequenceWallet() const
{
	return this->Wallet;
}
