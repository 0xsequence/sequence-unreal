...
class Ecdsa final {
	...
	// Note: renamed in this project due to Unreal engine's verify macro
	public: static bool ecdsa_verify(const CurvePoint &publicKey, const Sha256Hash &msgHash, const Uint256 &r, const Uint256 &s);
